...
const STEPS = [
    ...
    },
    {
        ...
        subItems: [
            { id: 'science-park-group', label: 'Kumamoto Science Park', icon: 'flask-conical',
              children: [
                  { id: 'gov-zones', label: 'Government zone clusters', icon: 'target' },
                  { id: 'kikuyo-plan', label: 'Kikuyo long-term plan', icon: 'map-pin' },
                  { id: 'ozu-plan', label: 'Ozu long-term plan', icon: 'map-pin' }
...
const AppData = {
    ...
    sewageInfrastructure: {
        ...
        description: 'Kumamoto Prefecture designated a Semicon Specified Public Sewage district to support expanded industrial and residential demand from the semiconductor corridor. The master plan covers multiple zones across the Koshi area.',
        stats: [
        ...
        evidence: {
            ...
            type: 'pdf',
            description: 'Kumamoto Prefecture urban plan sewerage change for Semicon Specified Public Sewage district',
    ...
    siliconIsland: {
        ...
        description: 'Japanese companies hold 8% of global semiconductor production value (¥74.6 trillion market, 2022), but dominate critical materials and equipment: silicon wafers (~60%), photoresist (~70%), encapsulation materials (~80%), and coating equipment (~90%).',
        stats: [
        ...
        evidence: {
            ...
            type: 'pdf',
            description: 'Japan global semiconductor production share and materials/equipment dominance data',
                ...
                },
                {
                    ...
                    data: {
                        basicSettings: {
                            ...
                            address: '3542-81 Shimomizusako, Aza Sugimizu, Ozu-machi, Kikuchi-gun, Kumamoto',
                            propertyType: 'Detached house (single-family)',
                            landArea: '117.62 sqm (approx. 35.6 tsubo)',
                            buildingArea: '89.10 sqm total (1F: 43.74 sqm, 2F: 45.36 sqm), 2 floors',
                ...
                },
                {
                    ...
                    data: {
                        ...
                        factors: [
                            ...
                            { title: 'Naka-Kyushu Cross Road', impact: 'Ozu-Kumamoto Road segment under construction, expressway link through corridor' },
                ...
                },
                {
                    ...
                    data: {
                        ...
                        rentalEvidence: {
                            ...
                            type: 'pdf',
                            description: 'Assessed rent ¥160,000/month from comparable properties',
                ...
                },
                {
                    ...
                    data: {
                        basicSettings: {
                            ...
                            address: '1315-18, 23 Maeda, Aza Kubota, Kikuyo-machi, Kikuchi-gun, Kumamoto',
                            propertyType: 'Detached house (single-family)',
                            landArea: '201.6 sqm (approx. 60.98 tsubo)',
                            buildingArea: '115.1 sqm total (1F: 62.93 sqm, 2F: 52.17 sqm), 2 floors',
                            layout: '4LDK, 3 parking spaces',
                ...
                },
                {
                    ...
                    data: {
                        ...
                        rentalEvidence: {
                            ...
                            type: 'pdf',
                            description: 'Assessed rent ¥170,000/month from 30 comparable properties',
                ...
                },
                {
                    ...
                    data: {
                        basicSettings: {
                            ...
                            plots: 'Lot 9 (Minamijuke) and Lot 123 (Mukaihara), Aza Haramizu, Kikuyo-machi',
    ...
    infrastructureRoads: [
        {
            ...
            description: 'Longest segment of the Naka-Kyushu Cross Road, connecting Koshi to Ozu-West IC in two sections (9.1km Koshi to Kumamoto, started 2020; 4.7km Ozu-West to Koshi, started 2022). Runs directly north of the semiconductor corridor.',
            documentLink: '#'
        },
        {
            id: 'ozu-road',
            ...
            driveToJasm: 'Adjacent',
            commuteImpact: '4.8km',
            description: 'Eastern segment connecting Ozu-West IC to the existing Ozu IC interchange. Project commenced in 2024 and is currently under survey. Completes the expressway link to the Ozu area east of the semiconductor corridor.',
            documentLink: '#'
        },
        {
            ...
            commuteImpact: '3.9km',
            description: 'Western extension connecting the Ueki IC area to the Kumamoto-Kita junction. Project commenced in 2025 and is currently under survey. Will provide expressway access from western Kumamoto into the corridor.',
            documentLink: '#'
        }
    ],
        ...
        'energy-infrastructure': {
            ...
            items: [
                ...
                },
                {
                    ...
                    date: '2024-09',
                    viewed: false,
                    description: 'Kyushu wind generation complements solar as part of the region\'s renewable energy base. As of September 2024, installed wind capacity reached 640 MW. Combined with solar, total renewable capacity stands at 12.88 GW.',
                    coords: [32.68, 130.42],
                    image: 'assets/use-case-images/evidence-renewable-energy.webp',
                    stats: [
                ...
                },
                {
                    ...
                    date: '2024-10',
                    viewed: false,
                    description: 'Kumamoto Prefecture urban plan sewerage change designating the Kumamoto Semicon Specified Public Sewage district. The 1:12,000 master plan map covers multiple zones across the Koshi and semiconductor corridor area to support expanded industrial and residential demand.',
                    coords: [32.87, 130.80],
                    image: 'assets/use-case-images/evidence-sewers-utility-systems.webp',
                    stats: [
                        { value: '1:12,000', label: 'Plan scale' },
            ...
            items: [
                {
                    ...
                    date: '2025-01',
                    viewed: false,
                    description: 'Four-segment expressway system extending from Ueki IC through Koshi to Ozu IC, running north of the semiconductor corridor. Connects western Kumamoto to the existing expressway network at Ozu IC. Segments range from under survey to under construction.',
                    coords: [32.87, 130.78],
                ...
                },
                {
                    ...
                    date: '2024-11',
                    viewed: false,
                    description: 'A new station is planned on the JR Hohi Line between Sanrigi and Haramizu stations in Kikuyo Town. The station will serve the Semicon Techno Park corridor and the adjacent TSMC factory area, providing direct rail access from Kumamoto City to the semiconductor cluster.',
                    coords: [32.88, 130.81],
                ...
                },
                {
                    ...
                    date: '2025-02',
                    viewed: false,
                    description: 'Planned 6.8km rail extension from Kumamoto Station to Aso Kumamoto Airport via the JR Hohi Line corridor. Estimated travel time of 44 minutes (39 minutes with express service). Projected daily ridership of 4,900 to 5,500 passengers by 2035.',
                    coords: [32.84, 130.86],
                ...
                },
                {
                    ...
                    date: '2024-12',
                    viewed: false,
                    description: 'Railway cost structure and community transport status across the Kumamoto metropolitan area. Facility maintenance accounts for 50% of railway operating costs, with direct transport at 39% and other costs at 11%. Community transport map shows suburban municipalities served by shared taxis and community buses, with many bus routes carrying only 0-7 passengers per vehicle per day, highlighting underserved corridors.',
                    coords: null,
        ...
        'government-zones': {
            ...
            items: [
                ...
                },
                {
                    ...
                    date: '2025-01',
                    viewed: false,
                    description: 'Conceptual vision map for the New Grand Airport initiative. Identifies three development zones: north of airport (Kumamoto Science Park), south side of airport, and the Southern Prefecture Region. Shows strategic road connections to Fukuoka, Oita, Miyazaki, and Kagoshima via Kyushu Main Expressway, Central Kyushu Transversal Road, and Ariake Sea Coastal Road.',
                    coords: [32.84, 130.86],
        ...
        'education-pipeline': {
            ...
            items: [
                ...
                },
                {
                    ...
                    date: '2025-01',
                    viewed: false,
                    description: 'Dual-track system supporting families of foreign semiconductor engineers. International school expansion: Kyushu Lutheran Academy launched an International Elementary division with IB curriculum in English-Japanese bilingual environment; Kumamoto International School (KIS) is expanding facilities and hiring Taiwanese teachers for Taiwanese families. Public school transformation: Kumamoto City Board of Education deploys Japanese language instructors and translators to public schools to help foreign children integrate into local districts. Under the Internationalization Promotion Vision, foreign engineer families are treated as long-term residents, strengthening bilingual adaptability in public education.',
                    coords: [32.86, 130.79],
                    stats: [
        ...
        'semiconductor-ecosystem': {
            ...
            items: [
                ...
                },
                {
                    ...
                    date: '2024-12',
                    viewed: false,
                    description: 'Detailed map and table of 13 planned industrial parks around TSMC. Sites span Kikuchi, Koshi, Ozu, Mashiki, Tamana, Yamaga, and Kikuchi municipalities. Includes Kikuchi Techno Park (25ha, public, FY2026), Semicon Techno Park West (11.2ha, FY2025), Ozu site on Route 325 (7.9ha, FY2027), and JASM Phase 1 factory site (25ha). Mix of public and private development from 2023 to 2028.',
                    coords: null,
                ...
                },
                {
                    ...
                    date: '2024-08',
                    viewed: false,
                    description: 'Supply chain logistics map showing Kyushu as Japan\'s semiconductor hub and gateway to East Asia. Proximity to Taiwan (foundry), Korea (memory), and Shanghai (end-market and supply chain hinterland). All three connections within 1-2 days by sea and under 3 hours by air, offering shorter logistics times and integration advantages.',
                    coords: null,
            ...
            items: [
                {
                    ...
                    date: '2025-01',
                    viewed: false,
                    description: 'Population and land price trends around TSMC expansion. Ozu-machi land prices surged 33% (2023-2024), the highest increase nationally, rising from ¥43,000/sqm in 2014 to ¥77,000/sqm in 2024. Kikuyo-cho rose 30.8% to ¥95,600/sqm. TSMC corridor population has grown steadily, with Kikuyo reaching approximately 63,000 and showing 29% growth over the measured period.',
                    coords: null,
                ...
                },
                {
                    ...
                    date: '2025-01',
                    viewed: false,
                    description: 'Loan and yield analysis for existing property renovation scenarios at three price points (¥42M, ¥44M, ¥46M). Purchase incurs 7% fees; 1-2 months preparation with furnished rental fitout. Gross yield ranges from 4.26-5.22% depending on price and rent tier. Loan terms: 50% LTV, 20-year term, 2.50% interest rate, with monthly payments from ¥111,280 to ¥121,878.',
                    coords: null,
